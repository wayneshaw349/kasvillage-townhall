...
// titles (exact text from dump)
rep(
">Paste Seller's Refund Template</Text>",
">BUYER STEP 1 \u2014 Paste Seller's Refund Template</Text>",
"title-amber");
rep(
...
"title-green");
rep(
">Paste Buyer's Refund Sign</Text>",
">SELLER STEP 2 \u2014 Paste Buyer's Refund Sign</Text>",
"title-purple");

// guard at accept flow (2702): chosen role vs derived canon.role
rep(
...
fs.writeFileSync(F+'.bak_rolegate2',O);fs.writeFileSync(F,s);console.log('patched ok -',n);
