// patch257_pindice_v4.cjs — pinned dice, replaces ALL 4 d1/d2 setFlagExpr sites
...
must(A2, 4, "A2 d1 setFlagExpr");
must(A3, 4, "A3 d2 setFlagExpr");
...
s = s.split(A2).join('\\"setFlagExpr\\",\\"args\\":[\\"d1\\",\\"pinroll(1)\\"]');
s = s.split(A3).join('\\"setFlagExpr\\",\\"args\\":[\\"d2\\",\\"pinroll(2)\\"]');
