// make_fight_showcase2.cjs — writes showcase_audio.html
...
const scene = {
  ...
  meta: { id: "audio", title: "audio", seed: "a1" },
...
fs.writeFileSync("showcase_audio.html", engine.slice(0, idx) + inject + engine.slice(idx));
console.log("OK showcase_audio.html — mash the 4 buttons: chains + alternating limbs");
