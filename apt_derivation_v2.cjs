// apt_derivation_v2.cjs
// Creates apt_derivation.ts with adaptive hex length
// 6 hex → 16.7M, auto-grows to 7 (268M), 8 (4.3B), up to 12 (281T)
const fs = require('fs');
...
fs.writeFileSync(path.join(__dirname, 'apt_derivation.ts'), util, 'utf8');
console.log('✅ Created apt_derivation.ts (adaptive 6→12 hex)');
console.log('   6 hex → 16.7M | 7 → 268M | 8 → 4.3B | 12 → 281T');
