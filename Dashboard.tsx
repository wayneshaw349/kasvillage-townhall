    ...
    <Card variant="green" style={walletStyles.statsCard}>
      ...
      <View style={{ marginTop: 8 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 6 }}>
          ...
          <Text style={{ color: "#E67E22", fontSize: 13 }}>{(Number(ds.totalBalanceSompi - ds.spendableBalanceSompi) / 1e8).toFixed(4)} KASPA</Text>
        </View>
        <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 6 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 6 }}>
          ...
          <Text style={{ color: "#27AE60", fontSize: 14, fontWeight: "bold" }}>{(Number(ds.spendableBalanceSompi - ds.iousOwedSompi) / 1e8).toFixed(4)} KASPA</Text>
        </View>
        <View style={{ height: 1, backgroundColor: "#333", marginVertical: 8 }} />
        <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 6 }}>
