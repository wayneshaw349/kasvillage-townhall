        ...
        <ScrollView style={styles.content}>
          ...
          <View style={styles.balanceBox}>
            ...
            {usdPerKas ? (
              <Text style={styles.balanceUsd}>
                {String.fromCharCode(8776)} {'$' + (Number(balance) / 1e8 * usdPerKas).toFixed(2)} USD
              </Text>
            ) : null}
          </View>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Your Kaspa address is public. Anyone can see your balance and transaction history.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  qrContainer: { alignItems: 'center', marginBottom: rs.s(20), marginTop: rs.s(12) },
